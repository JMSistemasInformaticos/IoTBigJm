//Arteaga Zambrano Bryan David
//Rivera Alvarado Rosa Guadalupe
//Ubilla Reyes Mario David
...
void setup(){
  ...
  // Print user UID
  //se obtiene el toquen para asignale las lectruas 
...
void loop(){
  ...
  //vlidacion  para verificar si esta o no logiado en firebase y cada cuanto se hace una lectura
